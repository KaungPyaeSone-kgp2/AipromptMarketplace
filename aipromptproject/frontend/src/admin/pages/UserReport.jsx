...
//       setError(null);
//       try {
//         const response = await fetch("/api/admin/get-user-report.php", {
//           method: "POST",
//           headers: {
...
//         if (!response.ok) {
//           throw new Error("Failed to fetch user reports from the backend.");
//         }
...
//   // Update status function (handles both DB and optimistic UI updates)
...
//     try {
//       const response = await fetch("/api/admin/update-user-report-status.php", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//         // If it fails, you could revert the UI state here if desired
//       }
//     } catch (err) {
...
//                   <h3 className="text-xs uppercase text-red-400 font-semibold mb-3">
//                     Reported User
//                   </h3>
//                   <div className="flex items-center gap-3">
//                     <img
//                       src={
//                         selectedReport.reported_user_image ||
//                         "https://via.placeholder.com/150"
//                       }
//                       alt="Target"
//                       className="w-12 h-12 rounded-full border border-red-500/20 object-cover"
//                     />
//                     <span className="text-white font-medium">
