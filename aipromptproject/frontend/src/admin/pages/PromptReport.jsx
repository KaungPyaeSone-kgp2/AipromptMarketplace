...
//       setError(null);
//       try {
//         const response = await fetch("/api/admin/get-prompt-report.php", {
//           method: "POST",
//           headers: {
...
//         if (!response.ok) {
//           throw new Error("Failed to fetch prompt reports from the backend.");
//         }
...
//         "/api/admin/update-prompt-report-status.php",
//         {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
...
//         <h1 className="text-2xl font-bold text-white">Prompt Reports</h1>
...
//                       </span>
//                     </td>
//                     <td className="p-4 capitalize">{report.reason}</td>
//                     <td className="p-4">
//                       <span
...
//                 <div className="bg-[#C4B5FD]/5 p-4 rounded-xl border border-[#C4B5FD]/20">
//                   <h3 className="text-xs uppercase text-[#C4B5FD] font-semibold mb-3">
//                     Prompt Creator
//                   </h3>
//                   <div className="flex items-center gap-3">
//                     <img
//                       src={
//                         selectedReport.prompt_author_image ||
//                         "https://via.placeholder.com/150"
//                       }
//                       alt="Creator"
//                       className="w-12 h-12 rounded-full border border-[#C4B5FD]/30 object-cover"
//                     />
//                     <span className="text-white font-medium">
//                       {selectedReport.prompt_author_name}
//                     </span>
//                   </div>
//                 </div>
//               </div>
...
//                   <span className="text-gray-400">Prompt Title</span>
//                   <span className="text-white font-semibold">
//                     {selectedReport.prompt_title || "N/A"}
//                   </span>
//                 </div>
//                 <div className="flex items-center justify-between border-b border-white/5 pb-3">
