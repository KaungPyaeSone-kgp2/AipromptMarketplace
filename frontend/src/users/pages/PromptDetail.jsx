          ...
          <div className="mt-6 border-t border-slate-700/70 pt-6">
            ...
            <div className="mt-6 flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1 text-xs font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800 hover:text-violet-600 dark:hover:text-violet-300 transition-all"
