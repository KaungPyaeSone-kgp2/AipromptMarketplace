...
import homepicture_1 from "../../assets/Autumn Haze.jpg";
import homepicture_2 from "../../assets/Insta-Escape.jpg";
import homepicture_3 from "../../assets/Ethereal Girl.png";
import homepicture_4 from "../../assets/homepicture(4).jpg";
import homepicture_5 from "../../assets/canvas and character.jpg";
            ...
            <div>
              <div className="gallery-track anim-down">
                {track1Images.map((imgUrl, i) => (
                  <div
                    className="iso-card cursor-pointer"
                    key={`t1-${i}`}
