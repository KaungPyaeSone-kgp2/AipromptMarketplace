  ...
  return (
    <footer className="w-full bg-[#050505] border-t border-white/10 pt-16 pb-8 relative z-30 mt-auto">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        {/* Bottom */}
        <div className="flex flex-col sm:flex-row items-center justify-between border-t border-white/10 pt-8 gap-4 text-center sm:text-left">
          <p className="text-[#71717a] text-sm">
            &copy; {currentYear} DreamKey. All rights reserved.
          </p>
          <div className="text-[#71717a] text-sm flex items-center justify-center sm:justify-end gap-1.5 flex-wrap">
            <span>Crafted for creators of the</span>
            <Wand2 className="w-4 h-4 text-[#fca311] shrink-0" />
            <span>AI era.</span>
          </div>
        </div>
      </div>
