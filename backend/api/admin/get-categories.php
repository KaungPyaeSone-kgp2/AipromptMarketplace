...
//     // 2. Fetch categories and count total prompts per category
//     $sql = "SELECT 
//                 c.id, 
...
//             "lastUpdated" => date("M d, Y", strtotime($cat["updated_at"])), 
//             "prompts" => [] // Keeping empty array to prevent frontend crash on Detail view
//         ];
//     }, $categories);
